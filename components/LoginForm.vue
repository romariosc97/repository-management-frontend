            ...
            <div class="max-w-md w-full space-y-8">
                ...
                <form class="mt-8 space-y-6" action="#" method="POST" @submit.prevent="login">
                    ...
                    <div class="flex justify-center">
                        <button type="submit" :disabled="btnLoading" class="disabled:opacity-50 group relative w-36 flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                            <svg v-if="btnLoading" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 animate-spin" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            async login() {
                ...
                try {
                    ...
                    if(response.data.success){
                        ...
                        this.$store.commit('setToastConf', {message: 'Invalid credentials.', type: 'Error'});
